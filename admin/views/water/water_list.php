...
<div class="container">
    ...
    <table>
        ...
        <?php foreach ($list as $w): ?>
            <?php 
                $monthMatch = !$selectedMonth || strpos($w['month'], $selectedMonth) !== false;
                $yearMatch = !$selectedYear || strpos($w['month'], $selectedYear) !== false;
                $roomMatch = !$selectedRoom || $w['room_code'] == $selectedRoom;
