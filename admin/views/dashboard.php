    ...
    <div class="dashboard-main">
      <div class="dashboard-topbar">
        ...
        <form method="get" class="form-month">
          ...
          <!-- <label style="font-size:0.85rem;color:#64748b;margin:0 4px;">Tháng</label> -->
          ...
          <!-- <label style="font-size:0.85rem;color:#64748b;margin:0 4px;">Năm</label> -->
      ...
      <div class="dashboard-stats-grid">
        ...
        <div class="dashboard-stat-card">
          <small>Số phòng còn trống</small>
      ...
      <!-- Bộ lọc tháng và biểu đồ -->
      <div class="chart-grid" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(min(100%, 500px), 1fr)); gap: 1.5rem; margin-bottom: 2rem;">
        ...
        <div class="dashboard-chart-section">
          <h3>💧 Thống kê nước</h3>
          <div style="height: 52px;"><!-- Khoảng trống tương đương form --></div>
        ...
        <div style="margin-top:2rem;">
          <div style="display:grid; grid-template-columns: repeat(auto-fit, minmax(min(100%, 500px), 1fr)); gap:1.5rem;">
            <div class="dashboard-chart-section" style="margin-bottom:0;">
              <h4 style="margin-bottom:1rem;color:#1e293b;font-size:1rem;">Doanh thu theo tháng trong năm <?= $statYearOnly ?></h4>
              <canvas id="monthlyRevenueChart" style="max-height:280px;"></canvas>
            </div>
            
            <div class="dashboard-chart-section" style="margin-bottom:0;">
              <h4 style="margin-bottom:1rem;color:#1e293b;font-size:1rem;">Doanh thu các năm</h4>
              <canvas id="yearlyRevenueChart" style="max-height:280px;"></canvas>
            </div>
          </div>
        </div> -->
      ...
      <!-- Danh sách khách và hóa đơn -->
      <div class="info-grid" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(min(100%, 500px), 1fr)); gap: 1.5rem;">
        <div class="dashboard-chart-section">
