...
<div class="container">
    ...
    <form method="post">
        ...
        <input type="number" name="unit_price" id="unit_price" value="15000" min="0" oninput="calcDTT();">
...
function calcDTT() {
    ...
    var dtt = csm - csc;
    var unit_price = parseInt(document.getElementById("unit_price").value) || 15000;
    document.getElementById("DTT").value = dtt > 0 ? dtt : 0;
    document.getElementById("total").value = (dtt > 0 ? dtt : 0) * unit_price;
}
