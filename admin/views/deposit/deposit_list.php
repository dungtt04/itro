...
$headContent = '<style>
    ...
    th, td { border: 1px solid #bfc7d1; padding: 12px 8px; text-align: center; font-size: 14px; }
        ...
        <table>
            <thead>
                <tr style="text-align: center;">
                    ...
                    <th class="phone">Số tiền hoàn</th>
                    <th>Thao tác</th>
                </tr>
            </thead>
            <tbody>
                <?php foreach ($deposits as $index => $deposit): ?>
                    <tr>
                        ...
                        <td class="phone"><?= $deposit['refund_amount'] ? number_format($deposit['refund_amount'], 0, ',', '.') . ' đ' : '-' ?></td>
