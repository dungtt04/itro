        ...
        <?php foreach ($customers as $c): ?>
            ...
            <tr class="main-row">
                ...
                <td data-label="Ngày sinh">
                    <?php $dob = $c['dob'] ? date('d/m/Y', strtotime($c['dob'])) : ''; echo htmlspecialchars($dob); ?>
                </td>
                <td class="desktop-only" data-label="Ngày cấp">
                    <?php $cccd_date = $c['cccd_date'] ? date('d/m/Y', strtotime($c['cccd_date'])) : ''; echo htmlspecialchars($cccd_date); ?>
                </td>
                ...
                <td colspan="9">
                    <div style="padding:10px 0 0 0;">
                        ...
                        <div class="acton" style="margin-top:10px; text-align:right; margin-right: 20px; margin-bottom: 10px;">
                            <a href="index.php?controller=customer&action=delete&id=<?= $c['id'] ?>" onclick="return confirm('Xóa khách thuê này?');" class="action-btn" style="background:#d93025;color:white; text-decoration:none; margin:5px 5px; border-radius: 2px; padding:5px 5px;">Xóa</a>
